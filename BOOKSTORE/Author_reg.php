...
<label  for="reg"><span class="text-Italic" style="color:white" >&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<u><b>AUTHOR&nbsp&nbspREGISTRATION&nbsp&nbspFORM</b></u></label><br><br>
...
<script> function fun1() { window.location="Author_login.php"; } </script></br>
Click here for &nbsp&nbsp
