...
<label  for="reg"><span class="text-Italic" style="color:white" >&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<u><b>AUTHOR&nbsp&nbspLOGIN&nbsp&nbspFORM</b></u></label><br><br>
...
<span class="text-Italic" style="color:white" ></br>
...
<script> function fun2() { window.location="Author_reg.php"; } </script></br>
...
$query=mysql_query("select * from author where username='$username' and password='$password'") or die(mysql_error());
   ...
   $_SESSION['username']=$userrname;
	...
	header("location: author_home.php?id=".$username);
   }
   else
   {
