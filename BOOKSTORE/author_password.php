...
?>
<head>
<title>Change Auyhor Password</title>
</head>
...
.bg{
	background:url("ppp.jpg") center center no-repeat;
...
<label for="password"><span class="text-Italic" style="color:black" ><b>Password:</b></label> 
<input placeholder="Enter your password" type="password" name="password"/></br>

<label for="password"><span class="text-Italic" style="color:black" ><b>Retype Password:</b></label> 
...
if($password==$retype)
{
$query="update author set password='$password' where username='$get_username'";
...
echo "<br>";
echo " <a href='author_password.php'>View result</a>"; 
} 
