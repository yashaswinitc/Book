...
.bg{
	background:url("999.jpg") center center no-repeat;
...
<label  for="reg">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<u><b>UPDATE CUSTOMER DETAILS</b></u></label><br><br>
...
$query="update customer set password='$password',cus_address='$address',cus_phone='$phno'  where username='$get_username'";
