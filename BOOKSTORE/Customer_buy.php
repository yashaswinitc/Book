...
<script> function fun2() { window.location="Customer_home.php"; } </script></br>
...
?>
<label  for="reg">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<u><b>&nbsp&nbspCustomerDETAIL&nbsp&nbsp</b></u></label><br><br>
