...
<form action="ad_author_book_search.php" method="get"><br/><br/>

<b>Search the book here: </b><input type="text" name="value" placeholder="Search here" style="width:150px;height:35px;font:bold 15px Times New Roman;">&nbsp &nbsp
...
<script> function fun1() { window.location="ad_author_home.php"; } </script></br>
...
$query="select * from details_of_books where btitle like '$search_value%'";
?>
