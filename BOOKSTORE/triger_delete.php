...
$sql = "CREATE TRIGGER MysqlTrigger2 AFTER DELETE ON details_of_books FOR EACH ROW UPDATE category SET no_of_books=no_of_books-1 WHERE category=OLD.category;";
...
if( isset($_POST['submit']) )
	{
	    ...
	    $e = $_POST['category'];
			...
			$qry = mysql_query("delete from details_of_books where bid='$a' and category='$e'");
