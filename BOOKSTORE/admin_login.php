...
<label  for="reg"><span class="text-Italic" style="color:white" > &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<u><b>ADMIN&nbsp&nbspLOGIN&nbsp&nbspFORM</b></u></label><br><br>
...
$query=mysql_query("select * from admin_login where username='$username' and password='$password'") or die(mysql_error());
   ...
   $_SESSION['username']=$userrname;
	...
	header("location: admin_home.php?id=".$username);
		//header("location: _home.php?id=".$username);
   }
   else
   {
