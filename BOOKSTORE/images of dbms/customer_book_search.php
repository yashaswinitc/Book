...
<b>Search for the Book here: </b><input type="text" name="value" placeholder="Search here" style="width:150px;height:35px;font:bold 15px Times New Roman;">&nbsp &nbsp
...
$query="select * from detail_of_book where btitle like '$search_value%'";
