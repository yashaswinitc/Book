...
<form action="admin_book_search.php" method="get"><br/><br/>

<b><span class="text-Italic" style="color:black" >Search the book here: </b><input type="text" name="value" placeholder="Search here" style="width:150px;height:35px;font:bold 15px Times New Roman;">&nbsp &nbsp
<input type="submit" name="search" value="Search Now" style="width:100px;height:35px;font:bold 15px Times New Roman;"></br>

<span class="text-Italic" style="color:black" >Click here for &nbsp&nbsp
